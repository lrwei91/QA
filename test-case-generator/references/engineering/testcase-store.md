...
- Markdown：`testcases/generated/测试用例_<模块或主题>.md`
- Excel：`testcases/generated/测试用例_<模块或主题>.xlsx`
...
```bash
python3 scripts/upsert_testcase_index.py testcases/generated/运营活动/锦标赛.xlsx
```
