...
│   │   ├── validate_index.py
│   │   ├── cleanup_testcase_store.py
│   │   ├── xlsx_fill_testcase_template.py
│   │   ├── xlsx_append_and_highlight.py
│   │   ├── snapshot_testcase.py
│   │   ├── sync_testcase_snapshot.py
│   │   ├── export_testcase_report.py
│   │   └── parse_axure_html.py
│   └── skills/                  # 技能定义
...
# ===== Excel 处理 =====
# 填充 Excel 模板
python3 engine/scripts/xlsx_fill_testcase_template.py rows.json output.xlsx

# 追加用例并标黄
python3 engine/scripts/xlsx_append_and_highlight.py existing.xlsx new_rows.json output.xlsx --highlight
...
# 查看快照历史
python3 engine/scripts/view_snapshot_history.py outputs/snapshots/运营活动/复充返利活动/
