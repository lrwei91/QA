...
使用示例:
  ...
  python3 upsert_testcase_index.py testcases/i18n/模块/主题.json
        '''
    )
    parser.add_argument(
        'file_path',
...
```bash
# 测试单个 JSON 文件
python3 test-case-generator/scripts/validate_i18n_json.py testcases/i18n/个人中心/个人中心 - 免费旋转记录.json
...
```bash
# 使用 pytest 运行测试（未来实现）
pytest --cov=test-case-generator/scripts test/
...
- 脚本手册：`test-case-generator/scripts/README.md`
- 快速入门：`user-guide.md`
